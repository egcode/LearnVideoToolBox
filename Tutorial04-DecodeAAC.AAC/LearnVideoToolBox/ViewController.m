...
- (void)viewDidLoad {
    ...
    self.mLabel.text = @"Test ACC playback";
    ...
    self.mDispalyLink.frameInterval = 5; // The default is 30FPS frame rate recording
...
- (void)updateFrame {
    if (player) {
        self.mCurrentTimeLabel.text = [NSString stringWithFormat:@"Current time: %.1fs", [player getCurrentTime]];
    }
}
